...
import icon_icepourover from "../images/enjoy/icon_iced_pour_over.png";
...
// pourover
import pourover1 from "../images/enjoy/coffee_pourOver_img01.jpg";
import pourover2 from "../images/enjoy/coffee_pourOver_img02.jpg";
import pourover3 from "../images/enjoy/coffee_pourOver_img03.jpg";
import pourover4 from "../images/enjoy/coffee_pourOver_img04.jpg";
import pourover5 from "../images/enjoy/coffee_pourOver_img05.jpg";
// ice
import icepourover1 from "../images/enjoy/coffee_iced_pourOver_img01.jpg";
import icepourover2 from "../images/enjoy/coffee_iced_pourOver_img02.jpg";
import icepourover3 from "../images/enjoy/coffee_iced_pourOver_img03.jpg";
import icepourover4 from "../images/enjoy/coffee_iced_pourOver_img04.jpg";
import icepourover5 from "../images/enjoy/coffee_iced_pourOver_img05.jpg";
import icepourover6 from "../images/enjoy/coffee_iced_pourOver_img06.jpg";
//maker
    ...
    bottom : [
        {
            ...
            tip : "커피는 농산품과 같다는 점을 기억하세요.소량으로 자주 구입해야 가장 신선하게 즐길 수 있습니다."
        },
        {
            img :press2,
            num_img:num2,
...
const pourover = {
    ...
    bottom : [
        ...
        },
        {
            ...
            tip : "푸어 오버 시 항상 동일한 맛을 내도록 하려면 타이머를 사용하세요. 1컵을 만드는 데 약 3분 정도가 소요되도록 합니다."
        },
    ]
}
const icepourover = {
...
const coffemaker = {
    ...
    bottom : [
        ...
        },
        {
            ...
            num_img : num3,
            title : "커피 만들어 즐기기",
            tip : "브루어를 이용해 만든 커피는 신선하게 마셔야 가장 맛있습니다.한 번에 마실 정도의 커피를 만드세요. 커피를 다시 데우면 풍미가 약해질 수 있습니다.",
        },
    ]
}
const Data = [press,pourover,icepourover,coffemaker];
export default Data;